<div x-data="{ deleteActionOpen: false }"  class="col-span-2 md:col-span-2 flex items-center justify-center">
    ...
    <div
        ...
        <div
            ...
            <!-- Form -->
            <form wire:submit.prevent="deleteAction" class="px-7 py-6 space-y-4" id="DeleteActionForm">
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="flex items-center justify-end gap-2 pt-2">
                        ...
                        <x-loading-livewire-button wireTarget="deleteAction" wire:loading.attr="disabled" formId="DeleteActionForm" class="w-1/1  text-center flex justify-center  items-center bg-red-500 hover:bg-red-400">
