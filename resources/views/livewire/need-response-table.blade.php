            ...
            <tbody class="divide-y divide-gray-100">
                @forelse($documents as $doc) 
                    <tr class="hover:bg-gray-50/50 transition-colors cursor-pointer">
                        ...
                        <td class="px-6 py-6 text-gray-600 font-medium"><a href="{{ route('need-response.view', $doc->id) }}" class="text-sky-500 hover:text-sky-400 flex items-center text-sm gap-1">View<x-heroicon-o-information-circle class="w-5 h-5" /></a></td>
                    </tr>    
                @empty
                    <tr>
