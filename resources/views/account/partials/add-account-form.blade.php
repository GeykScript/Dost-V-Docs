     ...
     <form action="{{ route('accounts.store') }}" method="POST" id="addUserAccountForm">
        ...
        <div class="grid grid-cols-12 gap-5">
                            ...
                            <div class="col-span-12 md:col-span-6 "> 
                                ...
                                @error('username')
                                <p class="text-xs text-red-500 mt-1">{{ $username }}</p>
                                @enderror                           
                        </div>
                            <!-- Email -->
                            <div class="col-span-12 md:col-span-6">
                                ...
                                @error('email')
                                <p class="text-xs text-red-500 mt-1">{{ $email }}</p>
                                @enderror
                            </div>
                            <!-- First Name  -->
                            <div class="col-span-12 md:col-span-5">
                                ...
                                @error('first_name')
                                <p class="text-xs text-red-500 mt-1">{{ $first_name }}</p>
                                @enderror
                            </div>
                            <!-- Last Name  -->
                            <div class="col-span-12 md:col-span-5">
                                ...
                                @error('last_name')
                                <p class="text-xs text-red-500 mt-1">{{ $last_name }}</p>
                                @enderror
                            </div>
                            <!-- Suffix  -->
                            <div class="col-span-12 md:col-span-2">
                                ...
                                @error('suffix')
                                <p class="text-xs text-red-500 mt-1">{{ $suffix }}</p>
                                @enderror
                            </div>
                                ...
                                <div class="col-span-12 md:col-span-7 flex flex-col gap-4">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div 
                                            ...
                                            @error('unit_id')
                                                <p class="text-xs text-red-500 mt-1">{{ $unit_id }}</p>
                                            @enderror
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div 
                                            ...
                                            @error('position')
                                                <p class="text-xs text-red-500 mt-1">{{ $position }}</p>
                                            @enderror
                            ...
                            <div class="col-span-12 mt-5">
                                <div class="flex items-center justify-end gap-4">
                                        ...
                                        <x-loading-button formId="addUserAccountForm" class="capitalize">{{ __('Create Account') }}</x-loading-button>
                                    </div>
                                </div>
                            </div>
        </div>
