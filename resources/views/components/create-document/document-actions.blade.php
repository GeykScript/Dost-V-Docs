<div class="col-span-1 mt-4">
    <h4 class="text-lg font-bold text-gray-600 mb-6">Document Actions</h4>
    
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            
        {{-- Action --}}
        <div>
            <label class="block mb-2 text-sm font-bold text-gray-600">
            ...
            <div class="lg:col-span-2 mt-2">
                <h5 class="text-base font-bold text-gray-600 mb-4">From</h5>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        <label class="block mb-2 text-sm font-bold text-gray-600">
            ...
            {{-- Route To Section --}}
            <div class="lg:col-span-2 mt-2">
                <h5 class="text-base font-bold text-gray-600 mb-4">Route To</h5>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                            <label class="block mb-2 text-sm font-bold text-gray-600">
            ...
            <div class="lg:col-span-2 mt-2">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-3 min-h-[90px] flex items-start gap-2 flex-wrap cursor-text">
                    {{-- Selected Tag Pill --}}
                    <span class="inline-flex items-center gap-1.5 bg-cyan-100 text-cyan-500 text-xs font-bold px-3 py-1.5 rounded-md">
                        Juan Dela Cruz
