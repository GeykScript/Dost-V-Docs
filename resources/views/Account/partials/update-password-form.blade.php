<section>
    ...
    <form method="post" action="#" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-password-input id="update_password_password" name="password" type="password" class="mt-1 block w-full"
            placeholder=""
        ...
        <div class="flex items-center gap-4">
            <x-primary-button class="capitalize bg-red-500 text-white hover:bg-red-400">{{ __('Reset Password') }}</x-primary-button>
        </div>
    </form>
</section>